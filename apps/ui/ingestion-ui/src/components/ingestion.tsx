...
const FIRECRAWL_API_URL = "http://192.168.1.130:3002"; // Replace with your actual API URL whether it is local or using Firecrawl Cloud
      ...
      <Card>
        <CardHeader className="flex items-start justify-between mb-0 pb-4">
          <CardTitle className="flex items-center justify-between w-full space-x-2">
            <span className="text-base">Extract DNG content</span>
            <a
              href=""
              className="text-xs text-gray-500 font-normal px-3 py-1 bg-zinc-100 rounded-xl hover:bg-zinc-200 transition-colors"
            >
              DNG Extract Convert Validate Service Layer
            </a>
          </CardTitle>
          <div className="text-sm text-gray-500 w-11/12 items-center">
            Use this component to quickly quickly extract the data from the DNG API. Learn more on the{" "}
            <a
              href=""
